...
#define MANY_LESIONS // if defined, the number of lesions can be >65000
...
//#define COLORS // if defined, genotypes change colours when mutating. The colours can then be used to create an image of the tumour
